...
public:
    ...
    void msgEncryptor(string, string);
    void msgDecryptor(string);

    void msgEncryptorFile(string,string);
    void msgDecryptor2File(string, string);
    int getMaxSpace(string);
...
private:
    ...
    void hideMsg_inPixels();
    
    
    uint8_t bitToggle(int, int);
    bool isBitOn(int, int);
    void getHiddenMsg();
